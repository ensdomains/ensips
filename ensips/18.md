...
This ENSIP which extends [ENSIP-5: Text Records](./5.md) defines a set of text records that should be used for profile information, along with the format that each should have.
