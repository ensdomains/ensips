...
ensip:
    created: "2025-03-15"
    status: draft
ignoredRules: ["heading:annex:-fault-tolerance", "heading:annex:-tunneling", "heading:external-batch-gateways"]
---
...
* Add a trusted [external](#external-batch-gateways) batch gateway to CSP header
...
This is essentially the inverse of this [specification](#specification) &mdash;  instead of handling batch requests locally, <u>ALL</u> requests are routed to the external batch gateway and no fetches are performed locally on untrusted domains.
