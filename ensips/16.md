...
**Key Terminology:**
- **registry datastore** = A contract that stores subregistry and resolver addresses and other data for all names, keyed by registry address and label hash.
