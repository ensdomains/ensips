...
This ENSIP creates a standardized entry point for discovering agent context. By defining only the key and leaving the value format flexible, it enables experimentation while ensuring interoperability.
